...
<template>
  <AppLayout>
    <div class="report-tw bg-slate-50 min-h-screen pb-8">
      ...
      >
        ...
        <div class="relative z-10 flex justify-between items-center mb-4">
          ...
          <div class="flex items-center gap-2 flex-shrink-0">
            <button
              ...
              style="font-size:11px; min-height:44px;"
            >
        ...
        <div class="relative inline-block z-10">
          <button
            ...
            style="font-size:12px; min-height:38px;"
          >
      ...
      <!-- ═══ SUMMARY — Display scale (BOLEH besar) ═══ -->
      <div class="px-5 relative z-20 grid grid-cols-2 gap-3" style="margin-top:-36px;">
        <div class="bg-white rounded-[20px] shadow-[0_8px_24px_rgba(15,23,42,0.10)] p-4 min-w-0">
          <div class="text-slate-400 text-left whitespace-nowrap" style="font-size:12px; line-height:1.4;">
            ↑ Pemasukan
          </div>
          <div
            class="font-bold text-slate-800 text-left tracking-tight mt-1 truncate"
          ...
          <div
            :class="[
              'font-normal text-left mt-1.5 truncate',
      ...
      <div class="px-5 pt-6 space-y-5">
        ...
        <div class="bg-white rounded-[24px] shadow-[0_8px_24px_rgba(15,23,42,0.06)] p-5">
          <div class="flex justify-between items-center mb-3 gap-2">
            <div
              class="font-semibold text-slate-800 text-left truncate min-w-0 flex-1"
          ...
          <div class="relative bg-slate-100 rounded-full p-1 flex mb-4">
            ...
            <button
              ...
              style="font-size:11px; min-height:36px;"
            >
              {{ opt.label }}
            </button>
          </div>
        ...
        <div class="space-y-4">
          <div class="bg-white rounded-[24px] shadow-[0_8px_24px_rgba(15,23,42,0.06)] p-5">
            <div class="flex items-center gap-2 mb-3">
              ...
              <span class="font-semibold text-slate-800 text-left" style="font-size:18px;">
                Budget Health Score
              </span>
            </div>
            <div class="text-left">
              <span class="font-bold text-[#2F6BFF]" style="font-size:20px; line-height:1.2;">
                {{ healthScore }}
              </span>
          ...
          >
            <div class="flex items-center gap-2 mb-3 relative z-10">
              ...
              <span class="font-semibold text-left" style="font-size:18px;">Dana Darurat</span>
            </div>
            <template v-if="runwayMonths !== null">
              ...
              <div class="text-white/45 relative z-10 text-left" style="font-size:11px;">
                Target ideal: 6 bulan pengeluaran
              </div>
            </template>
            <div v-else class="text-white/60 relative z-10 text-left" style="font-size:12px;">
              Belum cukup data.
            </div>
        ...
        >
          <div class="font-semibold text-slate-800 mb-4 text-left" style="font-size:18px;">
          ...
          <div class="flex flex-col items-center gap-5">
            ...
            >
              ...
              <div class="absolute inset-0 flex flex-col items-center justify-center text-center">
                ...
                <div
                  class="font-bold"
                  style="font-size:clamp(15px,4vw,18px); line-height:1.1;"
                >
                  {{ formatShort(totalExpense) }}
                </div>
              </div>
            ...
            <div class="w-full flex flex-col gap-3">
              ...
              >
                ...
                <span class="text-slate-400 flex-shrink-0" style="font-size:12px;">
                  {{ formatShort(cat.total) }}
                </span>
                <span class="font-semibold text-slate-800 w-10 text-right flex-shrink-0" style="font-size:12px;">
                  {{ cat.percent }}%
                </span>
              </div>
            </div>
        ...
        >
          ...
          <div v-for="b in budgets" :key="b.category" class="mb-4 last:mb-0">
            <div class="flex justify-between mb-2 gap-2" style="font-size:14px;">
        ...
        <div>
          ...
          <div class="grid grid-cols-2 gap-3">
            <div class="bg-white rounded-[18px] shadow-[0_8px_24px_rgba(15,23,42,0.06)] p-3.5">
              ...
              <div class="text-slate-400 leading-snug" style="font-size:11px;">Pemasukan tertinggi</div>
              <div class="font-semibold leading-snug mt-0.5 break-words" style="font-size:14px;">
            ...
            <div class="bg-white rounded-[18px] shadow-[0_8px_24px_rgba(15,23,42,0.06)] p-3.5">
              ...
              <div class="text-slate-400 leading-snug" style="font-size:11px;">Pengeluaran tertinggi</div>
              <div class="font-semibold leading-snug mt-0.5 break-words" style="font-size:14px;">
            ...
            <div class="bg-white rounded-[18px] shadow-[0_8px_24px_rgba(15,23,42,0.06)] p-3.5">
              ...
              <div class="text-slate-400 leading-snug" style="font-size:11px;">Rata-rata harian</div>
              <div class="font-semibold leading-snug mt-0.5 break-words" style="font-size:14px;">
            ...
            <div class="bg-white rounded-[18px] shadow-[0_8px_24px_rgba(15,23,42,0.06)] p-3.5">
              ...
              <div class="text-slate-400 leading-snug" style="font-size:11px;">Hari paling boros</div>
              <div class="font-semibold leading-snug mt-0.5 break-words" style="font-size:14px;">
                {{ wastefulDayLabel }}
              </div>
            </div>
    ...
    <Teleport to="body">
      ...
      >
        <div class="bg-white rounded-t-[24px] w-full max-w-md p-6 pb-10">
          ...
          <div class="font-semibold mb-5 text-left" style="font-size:18px;">
          ...
          <button
            type="button"
            class="w-full py-3.5 rounded-[16px] font-medium text-slate-500 bg-slate-50"
            style="font-size:14px;"
...
function barHeight(v) {
  return Math.max(3, (v / maxBarVal.value) * 130)
}
