  ...
  <AppLayout>
    <div class="report-tw bg-slate-50 min-h-screen pb-8 overflow-x-hidden" style="max-width:100vw;">
      ...
      <div class="px-5 pt-4 space-y-4">
        ...
        <!-- ═══ FILTER ═══ -->
        <div class="relative bg-white rounded-full p-1.5 flex gap-1 shadow-[0_4px_14px_rgba(15,23,42,0.06)]">
          <div
        ...
        <!-- ═══ CHART ═══ -->
        <div class="bg-white rounded-[24px] shadow-[0_8px_24px_rgba(15,23,42,0.06)] px-5 pt-4 pb-5">
          ...
          <div class="flex gap-2">
            <div class="flex flex-col justify-between text-right flex-shrink-0" style="height:180px; width:32px;">
            ...
            <div class="flex items-end justify-between gap-1.5 flex-1 min-w-0 border-l border-slate-100 pl-2" style="height:180px;">
              <div v-for="item in barData" :key="item.period" class="flex flex-col items-center flex-1 min-w-0">
                <div class="flex items-end gap-1" style="height:150px;">
                  <div
          ...
          <div class="flex gap-4 justify-center pt-2 border-t border-slate-100">
        ...
        <div class="space-y-4">
          ...
          <div class="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-[24px] shadow-[0_8px_24px_rgba(15,23,42,0.15)] px-5 py-4 relative overflow-hidden">
